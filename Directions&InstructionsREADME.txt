...
This will then prompt you to give an url from a recipe from allrecipes.com. Input the full url and then hit enter. If you get a "list out of index range" error then you need to input the full url and not the shortcut one (where you stop after the numbers).
